<div class="content clearfix peanutButter-page">
        <div class="left-zone">
            <img class="main-image" src="/Assets/images/peanutButter/box.avif" alt="Main Image">
            <img class="mountain" src="/Assets/images/peanutButter/Montain.avif" alt="mountain">
            <div class="circle-images"></div>
        </div>
        <div class="right-zone">
            <h1>Peanut Butter</h1>
            <h2>1 CASE(4 BOXES)</h2>
            <p></p>Crunchy, nutty, and perfectly sweet. We’ve reimagined <br>
             your favorite peanut butter cereal with 4g net carbs, <br>
             14g complete protein, 170 calories, and no artificial ingredients.
            <h3>Peanut Butter</h3>
            <img class="wave" src="/Assets/images/peanutButter/tent.avif" alt="wave">
    ...
    document.body.className = 'peanutbutter-page';
