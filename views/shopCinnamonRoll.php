<div class="content clearfix cinnamonRoll-page">
        <div class="left-zone">
            <img class="main-image" src="/Assets/images/cinnamonRoll/box.avif" alt="Main Image">
            <img class="mountain" src="/Assets/images/cinnamonRoll/Montain.avif" alt="mountain">
            <div class="circle-images"></div>
        </div>
        <div class="right-zone">
            <h1>Cinnamon Roll</h1>
            <h2>1 CASE(4 BOXES)</h2>
            <p>Cinnamon cereal—hold the toast. We’ve reimagined your favorite cinnamon <br>
            cereal with 4g net carbs, 12g complete protein, 140 calories,<br>
             and no artificial ingredients.</p>
            <h3>Cinnamon Roll</h3>
            <img class="carrot" src="/Assets/images/cinnamonRoll/Carrot.avif" alt="carrot">
            <img class="wave" src="/Assets/images/cinnamonRoll/Carrot.avif" alt="wave">
    ...
    document.body.className = 'cinnamonRoll-page';
