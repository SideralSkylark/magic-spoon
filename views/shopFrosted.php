<div class="content clearfix frosted-page">
        <div class="left-zone">
            <img class="main-image" src="/Assets/images/frosted/box.avif" alt="Main Image">
            <img class="mountain" src="/Assets/images/frosted/Montain.avif" alt="mountain">
            <div class="circle-images"></div>
        </div>
        <div class="right-zone">
            <h1>Frosted</h1>
            <h2>1 CASE(4 BOXES)</h2>
            <p>Sweet, subtle and smooth with hints of vanilla and marshmallow. <br>
            We’ve reimagined your favorite simple cereal with 4g net carbs,<br>
             13g complete protein, 140 calories, and no artificial ingredients.</p>
            <h3>Frosted</h3>
            <img class="carrot" src="/Assets/images/frosted/Wave.avif" alt="carrot">
            <img class="carrot" src="/Assets/images/frosted/Wave.avif" alt="carrot">
    ...
    document.body.className = 'frosted-page';
