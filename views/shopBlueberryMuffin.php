<div class="content clearfix blueberryMuffin-page">
        <div class="left-zone">
            <img class="main-image" src="/Assets/images/blueberryMuffin/box.avif" alt="Main Image">
            <img class="mountain" src="/Assets/images/blueberryMuffin/Montain.avif" alt="mountain">
            <div class="circle-images"></div>
        </div>
        <div class="right-zone">
            <h1>Blueberry Muffin</h1>
            <h2>1 CASE(4 BOXES)</h2>
            <p>You won’t be able to resist the freshly baked and straight out of <br>
             the oven taste of our Blueberry Muffin cereal! We’ve reimagined<br>
              your favorite blueberry cereal with 5g net<br>
               carbs, 13g complete protein, 150 calories, and nothing artificial.</p>
            <h3>Blueberry Muffin</h3>
            <img class="carrot" src="/Assets/images/blueberryMuffin/Wave.avif" alt="carrot">
            <img class="wave" src="/Assets/images/blueberryMuffin/Wave.avif" alt="wave">
    ...
    document.body.className = 'blueberryMuffin-page';
        ...
        document.addEventListener("DOMContentLoaded", function () {
            const pageClasses = {
                ...
                'cinnamonRoll-page': [
                    '/Assets/images/cinnamonRoll/macros.avif',
                    '/Assets/images/cinnamonRoll/bowl.avif',
                    '/Assets/images/cinnamonRoll/showcase.avif',
                    '/Assets/images/cinnamonRoll/boxes.avif',
                    '/Assets/images/cinnamonRoll/milk.avif',
                    '/Assets/images/cinnamonRoll/label.avif'
                ],
                'blueberryMuffin-page': [
                    '/Assets/images/blueberryMuffin/macros.avif',
                    '/Assets/images/blueberryMuffin/bowl.avif',
                    '/Assets/images/blueberryMuffin/showcase.avif',
                    '/Assets/images/blueberryMuffin/boxes.avif',
                    '/Assets/images/blueberryMuffin/milk.avif',
                    '/Assets/images/blueberryMuffin/label.avif'
                ]  
            };
